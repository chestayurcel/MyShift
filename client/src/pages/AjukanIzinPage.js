...
const AjukanIzinPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await perizinanService.ajukanIzin(data);
    ...
    <Layout>
      ...
      <div className="card shadow-sm mb-4">
        <div className="card-header">
          <h5 className="mb-0">Form Pengajuan Izin</h5>
        </div>
      ...
      <div className="card shadow-sm">
        <div className="card-header">
          <h5 className="mb-0">Riwayat Pengajuan Izin Anda</h5>
        </div>
        <div className="card-body">
            ...
            <table className="table table-hover">
              ...
              <tbody>
                {riwayat.length > 0 ? (
                  ...
                  <tr>
                    <td colSpan="5" className="text-center">Belum ada riwayat pengajuan.</td>
                  </tr>
                )}
              </tbody>
            </table>
